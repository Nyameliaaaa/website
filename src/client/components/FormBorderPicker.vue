        ...
        <Listbox v-model="model" v-slot="{ open }">
            <div class="relative mt-1">
                <div>
                    ...
                    >
                    <ListboxButton
                        :class="['relative cursor-default py-2 pl-3 pr-10 text-left cursor-pinter', formField, outline]"
                        id="colors"
                    >
                        ...
                        <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2">
                            <Icon
                                ...
                                :class="['transition-all duration-300 text-ctp-text', open ? 'rotate-180' : 'rotate-0']"
                                size="28"
                                id="toc-chevron"
                            />
                        </span>
                ...
                >
                    ...
                    >
                        ...
                        >
                            <li
                                :class="[
                                    'relative select-none py-2 pl-3 pr-10',
                                    {
